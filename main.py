...
pygame.display.set_caption('Pac-Man Marathon Dev')
...
BG = pygame.image.load("assets/images/Fond_mainscreen.jpg")
...
def play():
    ...
    for i in range(1, 5):
        player_images.append(pygame.transform.scale(
            pygame.image.load(f'assets/images/player_pacman.png'), (45, 45)))
    ...
    def pause():
        loop = 1
        pause_text = font.render("PAUSE", 500, 150)
        font.render("Espace pour continuer", 500, 250)
...
def main_menu():
    ...
    while True:
        ...
        PLAY_BUTTON = Button(image=pygame.image.load("assets/images/Play Rect.png"), pos=(450, 650), 
                            text_input="JOUER", font=get_font(60), base_color="#FFFFFF", hovering_color="White")
        QUIT_BUTTON = Button(image=pygame.image.load("assets/images/Quit Rect.png"), pos=(450, 800), 
                            text_input="QUITTER", font=get_font(50), base_color="#FFFFFF", hovering_color="White")
